...
import (
	...
	"github.com/Appkube-awsx/awsx-kinesis/awssession"
...
func GetClient(region string, crossAccountRoleArn string, accessKey string, secretKey string, externalId string) *kinesis.Kinesis {
...
func assumeRole(roleArn string, sessionName string, externalId string, accesskey string, secretKey string, region string) *kinesis.Kinesis {
